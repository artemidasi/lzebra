...
export const items: Item[] = [
  {
    ...
    description:
      'Загрузите накладную / акт выполненных работ / строительную смету / счет фактуру / зарплатную ведомость. Эль-Зебра распознает документ и автоматически выгрузит поля в нужный вам шаблон',
    files: [
      {
        icon: (
          <svg
  ...
  },
  {
    ...
    description:
      'Начните с одного простого бизнес-процесса и постепенно внедряйте Эль-Зебру во все отделы компании',
    files: [
      {
        icon: (
          <svg
